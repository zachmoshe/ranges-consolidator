    ...
    def test_no_hierarchy_not_sorted(self):
        many_rs_ex = [ 
            [ranges([[1,10,20], [2,30,40], [3,20,30]]), 
             ranges([[None,0,10], [1,10,20], [None,20,30], [2,30,40], [3,20,30]]), 
             {"ex_at":3}],
            [ranges([[1,10,20], [2,200,250], [3,100,120]]), 
             ranges([[None,0,10], [1,10,20], [None,20,200], [2,200,250], [3,100,120]]), 
             {"ex_at":3}],
            [ranges([[1,10,20], [2,30,100], [3,20,25]]), 
             ranges([[None,0,10], [1,10,20], [None,20,30], [2,30,100], [3,20,25]]), 
             {"ex_at":3}],
            [ranges([[1,10,20], [2,30,100], [3,25,30]]), 
             ranges([[None,0,10], [1,10,20], [None,20,30], [2,30,100], [3,25,30]]), 
             {"ex_at":3}],
            [ranges([[1,10,20], [2,20,30], [3,35,40], [4,30,35]]), 
             ranges([[None,0,10], [1,10,20], [2,20,30], [None,30,35], [3,35,40], [4,30,35]]), 
             {"ex_at":4}],
        ]
    ...
    def test_hierarchy_sorted(self):
        many_rs = [ 
            ...
            [ranges([[1,10,100], [2,30,70], [3,40,50]]), 
             ranges([[None,0,10], [1,10,30], [2,30,40], [3,40,50], [2,50,70], [1,70,100]])],
            [ranges([[1,0,100], [2,30,70], [3,80,90]]), 
             ranges([[1,0,30], [2,30,70], [1,70,80], [3,80,90], [1,90,100]])],
            [ranges([[1,10,100], [2,30,70], [3,80,90]]), 
             ranges([[None,0,10], [1,10,30], [2,30,70], [1,70,80], [3,80,90], [1,90,100]])],
            ...
            [ranges([[1,10,110], [2,10,50], [3,20,30], [4,50,100], [5,70,80]]), 
             ranges([[None,0,10], [2,10,20], [3,20,30], [2,30,50], [4,50,70], [5,70,80], [4,80,100], [1,100,110]])],
